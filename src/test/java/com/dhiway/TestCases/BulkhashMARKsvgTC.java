...
public class BulkhashMARKsvgTC extends BaseClass 
{
    @Test
    public void BulkhashMARKsvg() throws InterruptedException, IOException { 
        String testcasename =  "Bulkhashmarksvg";
...
Thread.sleep(20000);
    ...
    if (createspace != null) {
       ...
       bulkmark.click();
       WebElement pngElement = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//li[@id='svg']")));
        pngElement.click();
