...
public class NewDownloadbtnwithPng extends BaseClass {
 @Test
    public void downloadButtonOption() throws InterruptedException, IOException {
        String testcasename = "NewDownloadwithPng";
...
Thread.sleep(2000);
            ...
            WebElement pngbtn = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("ul[class='d-flex width-100 p-0 pdf-row mt-1 justify-content-between'] img[alt='PNG small size']"))); //img[alt='Png']
           pngbtn.click();
            ...
            Screenshot.saveScreenshot(((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE),
                    "Screenshots/" + testcasename + "_" + dateTimeToday + "/DownloadNewPNG.jpg");
