...
public class Zipfilenewdownloadui extends BaseClass {
 @Test
    public void zipdownloadButtonOption() throws InterruptedException, IOException {
        String testcasename = "NewDownloadpdfwithoutbckgndzip";
...
WebElement Multiplefileoption=wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#radiobtn-multiple")));
Multiplefileoption.click();
            WebElement pdfWithoutBackground = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("img[alt='PDF without Bg']"))); //img[alt='PDF with Bg']
            pdfWithoutBackground.click();
            ...
            Screenshot.saveScreenshot(((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE),
                    "Screenshots/" + testcasename + "_" + dateTimeToday + "/DownloadNewZip.jpg");
