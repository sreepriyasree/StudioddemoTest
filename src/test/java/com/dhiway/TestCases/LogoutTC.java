...
public class LogoutTC extends BaseClass {
    ...
    @Test
    public void LoginOutWebsite() throws InterruptedException, IOException {
        String testcasename = "LogoutTC";
...
Loginbtn.click();
       ...
       WebElement createspace = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("create-space")));
        ...
        WebElement logoutBtn = driver.findElement(By.xpath("//button[@id='logout-id']"));
        logoutBtn.click();
        Thread.sleep(2000);  // Wait for logout process
        Screenshot.saveScreenshot(((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE),
                "Screenshots/" + testcasename + " " + datetimetoday + "/logoutscreen.jpg");
                ...
                //if (createspace != null) {
                    ...
                    String result = config.getProperty("StudioBaseUrl") + "auth/login";
