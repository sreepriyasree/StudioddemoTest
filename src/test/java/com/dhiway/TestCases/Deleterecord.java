...
public class Deleterecord extends BaseClass {
    ...
    public void DeleteSingle() throws InterruptedException, IOException {
        ...
        if (createspace != null) {
            ...
            if (issuedElement.isDisplayed()) {
                WebElement draftClick = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector(
            ...
            WebElement Deletebtn = wait.until(ExpectedConditions.elementToBeClickable(
                    By.cssSelector("button[class='btn-sm btn btn-danger h6 font-regular text-white mb-0 ml-2 p-2 mb-0 btn btn-primary'] span[class='align-bottom']")));
            Deletebtn.click();
    ...
    // **Retry Method for Clicking Elements**
